...
const PAULI_Y: ConstSizedMatrix<1, Complex> = ConstSizedMatrix::new([
    [Complex::new(0.0, 0.0), Complex::new(0.0, -1.0)],
    [Complex::new(0.0, 1.0), Complex::new(0.0, 0.0)],
]);

impl_operator!(PAULI_Y, Complex, Complex, PauliY, crate::toolbox::rotation::pauli_y::RotationPauliY, 1, 1.0, "");
...
mod test {
    ...
    fn test_pauli_y() {
        ...
        let pauli_y = PauliY::new(0);
        let ket = pauli_y.apply(ket, &mut register);
